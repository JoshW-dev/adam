...
def getMediaObjectStatus( mediaObjectId, params ) :
	...
	return makeApiCall( url, endpointParams, 'GET' ) # make the api callgetMediaObjectStatus
...
params['media_url'] = 'https://cdn.midjourney.com/7c17cdb8-9f95-4c4e-854b-9d4bf14e2c2f/grid_0.png' # url on public server for the post
params['caption'] = 'This is a Test'
params['caption'] += "\n#AI #Art #AdamAI " # caption for the post
